...
public class Item {
	...
	public double calculateVolumetricWeight() // its kinda polymorphism but there is no keywword like virtual in java it does automatically 
	{
		return 0;
	}

	public double calculateShippingFee() // its kinda polymorphism but there is no keywword like virtual in java it does automatically 
	{
		return (0);
	}
